const logoQonnectBlack = require('@/assets/image/logo/logo-qonnect-black.png')
const logoQonnectWhite = require('@/assets/image/logo/logo-qonnect-white.png')
const logoQonnectBlackFull = require('@/assets/image/logo/logo-qonnect-black-full.png')
